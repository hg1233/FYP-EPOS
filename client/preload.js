...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  orders_createLine: async (order_id, suborder_id, product_id, product_name, product_unit_price, product_qty, subtotal, line_comments) => ipcRenderer.invoke('orders:add-line', order_id, suborder_id, product_id, product_name, product_unit_price, product_qty, subtotal, line_comments),
